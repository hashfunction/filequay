...
FolderSail is Trieflow LLC’s Windows file manager with tabs, panes, an operation queue and local operation receipts. Receipts show final results, reported totals and selected paths, with explicit CSV export. They do not undo operations. FolderSail does not replace Explorer or change system defaults.

- Product: https://foldersail.trieflow.com
- Privacy: https://foldersail.trieflow.com/privacy
- Support: https://foldersail.trieflow.com/support

## Source and license

Based on [Files Community / Files](https://github.com/files-community/Files) v4.2.9 at `99951c66928c4da714da8b1dd46039421182cbab`, with original history retained. Copyright notices remain in their source files. The source contains both [MIT](LICENSE-MIT) and [MPL-2.0](LICENSE-MPL) material. Read [third-party notices](.github/NOTICE.md) for additional dependency and asset terms. FolderSail modifications and the original FolderSail icon are copyright 2026 Trieflow LLC.
