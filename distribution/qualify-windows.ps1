...
Invoke-Checked $qualificationPowerShell @('-NoProfile','-File','tests/packaging/test-uia-child-diagnostics.ps1')
...
Invoke-Checked $qualificationPowerShell @('-NoProfile','-File','tests/packaging/test-consumer-native-text.ps1')
