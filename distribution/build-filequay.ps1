...
Invoke-Checked $msbuild @('Files.slnx','-t:Restore','-p:Platform=x64','-p:Configuration=Release','-p:RestorePackagesWithLockFile=true','-v:quiet','-clp:ErrorsOnly')
